...
public abstract class Hero extends DungeonCharacter {
	 ...
	 */
	protected Hero(final String theName, final int theHitPoints, final int theMinDamage, final int theMaxDamage,
			final double theAttackOdds, final int theAttackSpeed, final double theBlockOdds, final double theSpecialSkillOdds) {
